...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
      <div className="container mx-auto flex items-center justify-between h-16 md:h-14 px-4">
        <Link to="/" className="flex items-center gap-2 mt-2 md:mt-0">
          <div className="w-9 h-9 rounded-lg bg-gradient-coral flex items-center justify-center shadow-sm">
