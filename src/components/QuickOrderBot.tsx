      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-full sm:w-[400px] h-[600px] max-w-[calc(100vw-3rem)] max-h-[70vh] sm:max-h-[80vh] bg-white rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.15)] border border-slate-200 flex flex-col z-50 overflow-hidden"
          >
            {/* Header */}
