    ...
    <div className="min-h-screen bg-background flex">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <Button
            ...
            onClick={async () => {
              ...
              // Redirect is handled automatically by Supabase Auth to the Google sign-in page
            }}
          >
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-ink items-center justify-center p-12">
        <div className="max-w-md text-center">
          <div className="w-24 h-24 rounded-3xl bg-[#FF7300] flex items-center justify-center mx-auto mb-6 shadow-xl">
