...
import { Printer, Mail, Phone, Eye, EyeOff } from "lucide-react";
        ...
        >
          ...
          {loginMethod === "phone" ? (
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-2">
                  <div className="w-20 px-3 py-2.5 rounded-lg border border-input bg-secondary text-sm text-foreground flex items-center justify-center">
                    +91
                  </div>
                  <input
                    type="tel"
                  ...
                  <div className="flex gap-2">
                    {[0, 1, 2, 3, 4, 5].map((i) => (
                      <input
                        ...
                        className="w-12 h-12 text-center px-2 py-2 rounded-lg border border-input bg-card text-foreground text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-ring"
                      />
                    ))}
                  </div>
                  <p className="text-xs text-muted-foreground mt-2">
                    Didn't receive? <button className="text-accent hover:underline">Resend OTP</button>
                  </p>
                </motion.div>
              )}
            ...
            <div className="space-y-4">
              ...
              <Button variant="coral" size="lg" className="w-full">Log In</Button>
            </div>
          )}
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-ink items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-primary-foreground/70">
            Connect with 500+ verified printing shops. Get visiting cards, banners, stickers & more delivered to your doorstep.
          </p>
          <div className="flex justify-center gap-6 mt-8">
            <div className="text-center">
              <p className="text-2xl font-display font-bold text-accent">18K+</p>
              <p className="text-xs text-primary-foreground/60">Happy Customers</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-display font-bold text-accent">500+</p>
              <p className="text-xs text-primary-foreground/60">Print Shops</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-display font-bold text-accent">1M+</p>
              <p className="text-xs text-primary-foreground/60">Orders Delivered</p>
            </div>
          </div>
        </div>
      </div>
