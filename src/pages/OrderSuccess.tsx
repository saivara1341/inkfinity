...
const OrderSuccess = () => {
  ...
  const totalPaid = orders.reduce((sum, o) => sum + Number(o.grand_total || (o.specifications as any)?.grand_total || 0), 0);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-foreground">
                          {mainOrder.estimated_delivery || (mainOrder.specifications as any)?.estimated_delivery
                            ? format(new Date(mainOrder.estimated_delivery || (mainOrder.specifications as any)?.estimated_delivery), "EEEE, MMM d")
                            : "TBD"}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-foreground">
                          {mainOrder.delivery_address || (mainOrder.specifications as any)?.delivery_address ? "Home Delivery" : "Shop Pickup"}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2 text-sm">
                      {orders.map(order => (
                        <div key={order.id} className="flex justify-between">
                          ...
                          <span className="text-foreground">₹{Number(order.grand_total || (order.specifications as any)?.grand_total || 0).toLocaleString("en-IN")}</span>
                        </div>
                      ))}
